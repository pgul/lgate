...
:ul.
:li.
чтобы сделать релкомовскую конференцию в fido r/o, нужно завести
...
:li.
чтобы сделать фидошную эху в релкоме r/o, нужно просто на нее не
...
и по cnews.
:p.
Если вы хотите свою личную релкомовскую почту читать фидошным редактором,
нужно в своем домашнем каталоге поместить файл :hp1.forward:ehp1., состоящий только
из вашего фидошного адреса, как он виден из релкома, и прописать себя
...
relcom с заменой вашего адреса на обычный релкомовский и ваш корреспондент
...
не пишется).
:p.
Например, адрес Pavel Gulchouck 2&colon.463/68 будет выглядеть из релкома как
...
:p.
При гейтовании из релкома как фидошный исходящий адрес ставится адрес
...
:p.
Например, мне можно из релкома писать на (кроме приведенного выше адреса)
:lines.
...
:p.       
При гейтовании из релкома большие письма разбиваются на части,
русская 'Н' заменяется на латинскую 'H'. Аттрибуты RRQ и CFM гейтуются
в обе стороны (за исключением длинного релкомовского адреса). При
